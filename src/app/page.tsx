...
const modules = [
  ...
  { name: "Mouse Events", icon: MdMouse, color: "bg-orange-100 text-orange-600", link: "/mouse-events" },
  { name: "Radio Button", icon: MdOutlineRadioButtonChecked, color: "bg-teal-100 text-teal-600", link: "/radio-button" },
    ...
    <div className="min-h-screen bg-gray-50 py-10 px-6">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
         ...
         {modules.map((module) => {
  const Icon = module.icon   // ✅ move here

  return (
    <Link key={module.name} href={module.link}>
      <div className="group h-36 flex flex-col items-center justify-center rounded-xl bg-white shadow-sm cursor-pointer transition-all duration-300 hover:shadow-xl hover:-translate-y-1">

        <div className={`text-3xl mb-3 p-3 rounded-full ${module.color} group-hover:scale-110 transition`}>
          <Icon />   {/* ✅ correct usage */}
        </div>
